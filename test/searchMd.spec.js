...
const search = require('../src/searchMd.js');

// const cwd = process.cwd();

const dirMd = 'C:\\Users\\aurel\\Documents\\Proyectos\\LIM013-fe-md-links\\directoryPruebaMd';
const result = [
  {
    href: 'https://nodejs.org/es/',
    text: 'Node.js',
    file:
      'C:\\Users\\aurel\\Documents\\Proyectos\\LIM013-fe-md-links\\directoryPrueba\\dos.md',
  },
  {
  ...
  },
  {
    ...
    file:
      'C:\\Users\\aurel\\Documents\\Proyectos\\LIM013-fe-md-links\\directoryPrueba\\masNumeros\\cinco.md',
  },
  {
  ...
  },
  {
    ...
    file:
      'C:\\Users\\aurel\\Documents\\Proyectos\\LIM013-fe-md-links\\directoryPrueba\\tres.md',
  },
  {
    href:
  ...
  },
  {
    ...
    text: '1. Preámbulo',
    file:
      'C:\\Users\\aurel\\Documents\\Proyectos\\LIM013-fe-md-links\\directoryPrueba\\uno.md',
  },
  {
...
// const dir = 'C:\\Users\\aurel\\Documents\\Proyectos\\LIM013-fe-md-links\\directoryPrueba';
// const result = ['C:\\Users\\aurel\\Documents\\Proyectos\\LIM013-fe-md-links\\directoryPrueba\\dos.md',
// 'C:\\Users\\aurel\\Documents\\Proyectos\\LIM013-fe-md-links\\directoryPrueba\\masNumeros\\cinco.md',
// 'C:\\Users\\aurel\\Documents\\Proyectos\\LIM013-fe-md-links\\directoryPrueba\\tres.md',
// 'C:\\Users\\aurel\\Documents\\Proyectos\\LIM013-fe-md-links\\directoryPrueba\\uno.md'];
...
describe('Deberia extraer los Markdown encontrados en un directorio', () => {
  ...
  it('Devuelve links de fileMD encontrados en directorios', () => {
    expect(search.findMd(dirMd)).toEqual(result);
  });
  // it('Devuelve [] si no encuentra archivos Markdown', () => {
  //   expect(search.findMd(dir)).toEqual([]);
  // });
});
// expect(search.findMd(`${cwd()}/directoryForTest/directoryExample`)).toEqual([`${cwd()}\\directoryForTest\\directoryExample\\FILEMD2.md`.normalize()]);
//   });
//   it('Devuelve [] si no encuentra links', () => {
//     expect(readDirectorySync(`${cwd()}/directoryForTest/directoryExample/FILEMD2.md`)).toEqual([`${cwd()}/directoryForTest/directoryExample/FILEMD2.md`]);
